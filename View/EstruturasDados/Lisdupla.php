...
<head>
    ...
    <link rel="stylesheet" href="View/Assets/css/Lisdupla.css">
</head>
<body class="pagina-lisdupla">
    ...
    <main class="conteudo-lisdupla">
        <nav class="indice">
            ...
            <a href="#insercoes">Inserções</a>
            <a href="#remocoes">Remoções</a>
        ...
        <section id="conceito" class="secao">
            ...
            <div class="bloco-contexto">
                <h3>Da lista comum para a lista encadeada</h3>
        ...
        <section id="comparacao" class="secao">
            <h2>Lista simples x lista dupla</h2>
