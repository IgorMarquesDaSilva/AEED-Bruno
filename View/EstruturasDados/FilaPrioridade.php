<?php require_once "View/Shared/header.php"; ?>
        ...
        <section class="aula-hero">
            <div>
                <span class="rotulo">Maior prioridade primeiro, FIFO no empate</span>
            ...
            <div class="aula-resumo">
                <strong>Fila de prioridades</strong>
                <span>Insere por prioridade, remove no início</span>
        ...
        <div class="aula-layout">
            ...
            <a href="#anatomia">Nó, prioridade e ordem</a>
            <a href="#operacoes">Operações principais</a>
            <a href="#insercoes">Inserção ordenada</a>
        ...
        <section id="conceito" class="secao">
            <h2>O que é uma fila de prioridades encadeada?</h2>
        ...
        <section id="anatomia" class="secao">
            <h2>Nó, prioridade e ordem</h2>
            <p>
                Assim como na fila comum, a fila de prioridades é formada por nós
                conectados. A diferença está no critério de organização: cada nó
                carrega uma prioridade, e a fila é mantida ordenada do maior para
                o menor nível de prioridade.
            </p>
        ...
        <section id="insercoes" class="secao">
            <h2>Inserção passo a passo (ordenada por prioridade)</h2>
            <p>
                Na Fila de Prioridades, o novo elemento não entra sempre no fim: ele
                é posicionado de acordo com sua prioridade, mantendo a fila sempre
        ...
        <section id="remocoes" class="secao">
            ...
            <p>
                A remoção continua acontecendo sempre no início (Cabeça) da fila,
                que é justamente onde fica o elemento de maior prioridade.
            </p>
        ...
        <section id="comparacao" class="secao">
            <h2>Fila encadeada x Fila de prioridades encadeada</h2>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Fila de prioridades encadeada</th>
                        </tr>
                    </thead>
                    <tbody>
