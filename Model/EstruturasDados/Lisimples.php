...
class Lisimples
{
    public function obterConteudo()
    {
        return [
            ...
            "introducao" => "Uma lista simplesmente encadeada organiza elementos em nós conectados. Diferente da lista simplesmente encadeada, cada nó conhece o elemento anterior e o próximo elemento.",

            "objetivos" => [
                "Entender como os nós se conectam em dois sentidos.",
                "Aprender as principais operações de inserção e remoção.",
                "Comparar lista simples e lista simples.",
                "Visualizar exemplos implementados em C#."
            ],

            "definicao" => "Uma lista simplesmente encadeada é uma estrutura de dados linear e dinâmica. Cada nó armazena um valor e duas referências: uma aponta para o nó anterior e outra aponta para o próximo nó.",
            ...
            "contexto" => [
                ...
                "Na lista simplesmente encadeada vista em aula, cada nó aponta apenas para o próximo. Na lista simples, acrescentamos a referência anterior, permitindo caminhar nos dois sentidos."
            ],
            ...
            "importancia" => "A lista simples é importante quando o sistema precisa navegar para frente e para trás ou remover elementos com facilidade depois que o nó foi encontrado.",
            ...
            "buscaPercurso" => [
                ...
                [
                    ...
                    "descricao" => "Começa em Fim e utiliza Anterior, possibilidade que diferencia a lista simples.",
                    "complexidade" => "O(n)"
                ]
            ],
            ...
            "comparacao" => [
                [
                    ...
                    "simples" => "Para o anterior e para o próximo"
                ],
                [
                    "criterio" => "Navegação",
                    "simples" => "Apenas para frente",
                    "simples" => "Para frente e para trás"
                ],
                [
                    "criterio" => "Memória",
                    "simples" => "Utiliza menos memória",
                    "simples" => "Utiliza mais memória"
                ],
                [
                    "criterio" => "Remoção",
                    "simples" => "Pode exigir procurar o anterior",
                    "simples" => "O anterior já está referenciado"
                ]
            ],
            ...
            "orientacaoCodigo" => "Os exemplos seguem o mesmo raciocínio das operações: primeiro definimos o nó e a lista, depois inserimos, percorremos, buscamos e removemos. Os métodos manuais devem ser colocados dentro da classe Listasimples apresentada no Exemplo 3.",
...
CSHARP
                ...
                [
                    ...
                    "descricao" => "O C# possui LinkedList<T>, que implementa uma lista simplesmente encadeada.",
                    "codigo" => <<<'CSHARP'
using System;
using System.Collections.Generic;

// LinkedList<T> já traz pronta a estrutura de lista simplesmente encadeada.
...
CSHARP
                ...
                [
                    ...
                    "descricao" => "Uma vantagem da lista simples é poder exibir os dados de frente para trás e de trás para frente.",
                    "codigo" => <<<'CSHARP'
...
CSHARP
            ...
            "exercicios" => [
                ...
                "Explique por que a lista simples utiliza mais memória que a lista simples."
            ]
        ];
    }
}
